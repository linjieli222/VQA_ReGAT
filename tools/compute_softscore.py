...
if __name__ == '__main__':
    train_answer_file = 'data/Answers/v2_mscoco_train2014_annotations.json'
    train_answers = json.load(open(train_answer_file))['annotations']

    val_answer_file = 'data/Answers/v2_mscoco_val2014_annotations.json'
    ...
    val_question_file = 'data/Questions/v2_OpenEnded_mscoco_val2014_questions.json'
    ...
    train_answer_file = 'data/cp_v2_annotations/vqacp_v2_train_annotations.json'
    train_answers = json.load(open(train_answer_file))

    test_answer_file = 'data/cp_v2_annotations/vqacp_v2_test_annotations.json'
    test_answers = json.load(open(test_answer_file))

    train_question_file = 'data/cp_v2_questions/vqacp_v2_train_questions.json'
    train_questions = json.load(open(train_question_file))

    test_question_file = 'data/cp_v2_questions/vqacp_v2_test_questions.json'
    ...
    compute_target(train_answers, ans2label, 'cp_v2_train')
    compute_target(test_answers, ans2label, 'cp_v2_test')
